...
export function FeaturedOffer() {
  ...
  return (
    <section
      id="featured"
      className="scroll-mt-16 bg-surface py-8 text-surface lg:py-12"
    >
      <div className="mx-4 overflow-hidden rounded-[2.5rem] bg-primary sm:mx-6 lg:mx-8">
        <div className="container-page section-y grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          <div className="relative order-2 mx-auto w-full max-w-xl lg:order-1">
            <span className="eyebrow absolute left-4 top-4 z-10 rounded-full bg-surface px-4 py-2 text-primary shadow-lift">
              Ashake exclusive
            </span>
            <FoodImage
              src={p.image}
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="mt-8">
              <Button to={`/menu/${p.id}`} size="lg" variant="dark">
                {p.category === "combo"
                  ? "Order This Combo"
                  : "Order This Offer"}
              </Button>
